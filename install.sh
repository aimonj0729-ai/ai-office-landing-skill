...
echo "   /landing --human"
echo ""
echo "4. 成本节省模式（Kimi/DeepSeek adapter）:"
echo "   export KIMI_API_KEY=\"your-key\""
echo "   export DEEPSEEK_API_KEY=\"your-key\""
echo "   /landing --cost-saving"
echo ""
echo "5. 强制指定 Executor adapter:"
echo "   /landing --adapter deepseek-api"
echo ""
echo "6. Skill 发现工具:"
echo "   ~/.claude/skills/ai-office-landing/discover-skills.sh auto-designer"
echo ""
echo "7. Orchestrator 汇总:"
